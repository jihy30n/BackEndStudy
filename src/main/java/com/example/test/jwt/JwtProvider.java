...
public class JwtProvider {
    ...
    public String createToken(String email, long tokenTime){
        ...
        claims.put("roles",memberEntity.getUserRole().toString());
    ...
    public MemberEntity findByUserOnToken(HttpServletRequest request) {
        ...
        return MemberRepository.findByEmail(userEmail).orElseThrow(()-> new NotFoundException(ErrorCode.NOT_FOUND_EXCEPTION, ErrorCode.NOT_FOUND_EXCEPTION.getMessage()));
    }
